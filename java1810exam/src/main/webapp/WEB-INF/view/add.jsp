...
<div class="panel admin-panel">
  <div class="panel-head" id="add">
  	<strong><span class="icon-pencil-square-o"></span>新增单选题</strong>
  </div>
  <div class="body-content">
    <form method="post" class="form-x" action="newSingleQuestion">  
...
<script type="text/javascript">
	...
	function addOption(){
		...
		$("#answerBox").append("<option value='"+optIndex+"'>"+c+"</option>");
		optIndex++;
	}
	//对分数设置的监听，分数不能低于1
