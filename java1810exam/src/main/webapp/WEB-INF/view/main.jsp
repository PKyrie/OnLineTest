...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="action//pass" target="right"><span class="icon-caret-right"></span>修改密码</a></li>
<!--     <li><a href="add.html" target="right"><span class="icon-caret-right"></span>网站管理</a></li>  
    <li><a href="adv.html" target="right"><span class="icon-caret-right"></span>首页轮播</a></li>   
    <li><a href="book.html" target="right"><span class="icon-caret-right"></span>留言管理</a></li>     
    <li><a href="column.html" target="right"><span class="icon-caret-right"></span>栏目管理</a></li> -->
  </ul>   
  <h2><span class="icon-pencil-square-o"></span>试题管理</h2>
  <ul>
    <li><a href="action/list" target="right"><span class="icon-caret-right"></span>内容管理</a></li>
    <li><a href="add" target="right"><span class="icon-caret-right"></span>添加单选题</a></li>
    <li><a href="addmore" target="right"><span class="icon-caret-right"></span>添加多选题</a></li>        
  </ul>  
</div>
...
<div class="admin">
  <iframe scrolling="auto" rameborder="0" src="add" name="right" width="100%" height="100%"></iframe>
</div>
</body>
</html>
